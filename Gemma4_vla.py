...
import os, sys
# 🌟 FORCE CORES AND SILENCE LOGS BEFORE ANY IMPORTS HAPPEN
...
def load_all():
    ...
    # 🌟 ADD THIS FIX FOR THE 12-CORE AGX ORIN:
    import onnxruntime as rt
    opts = rt.SessionOptions()
    opts.graph_optimization_level = rt.GraphOptimizationLevel.ORT_ENABLE_ALL
    # This explicitly forces ONNX to stop its broken thread-affinity logic
